...
impl Analysis for MemoryBudgetAnalysis {
    ...
    fn analyze(&self, instance: &SystemInstance) -> Vec<AnalysisDiagnostic> {
        self.check_memory_budgets(instance, None)
    }
}

impl ModalAnalysis for MemoryBudgetAnalysis {
    fn analyze_in_mode(
        &self,
        instance: &SystemInstance,
        som: &SystemOperationMode,
    ) -> Vec<AnalysisDiagnostic> {
        self.check_memory_budgets(instance, Some(som))
    }
}

impl MemoryBudgetAnalysis {
...
mod tests {
    ...
    fn as_modal_returns_some() {
        let analysis = MemoryBudgetAnalysis;
        assert!(
            analysis.as_modal().is_some(),
            "MemoryBudgetAnalysis should support modal analysis"
        );
    }
    ...
    fn modal_filters_inactive_bound_component() {
        ...
        // t_fast: 80 KB
        b.set_property(t_fast, "Memory_Properties", "Code_Size", "80 KByte");
        b.set_property(
            t_fast,
            "Deployment_Properties",
            "Actual_Memory_Binding",
        ...
        // t_slow: 100 KB
        b.set_property(t_slow, "Memory_Properties", "Code_Size", "100 KByte");
        b.set_property(
            t_slow,
            "Deployment_Properties",
            "Actual_Memory_Binding",
        ...
        let diags = MemoryBudgetAnalysis.analyze_in_mode(&inst, &som_fast);
        let infos: Vec<_> = diags
            .iter()
            .filter(|d| d.severity == Severity::Info && d.message.contains("utilization"))
            .collect();
    ...
    fn modal_non_modal_thread_included_in_all_soms() {
        ...
        b.set_property(t_always, "Memory_Properties", "Code_Size", "50 KByte");
        b.set_property(
            t_always,
            "Deployment_Properties",
            "Actual_Memory_Binding",
        ...
        b.set_property(t_fast, "Memory_Properties", "Code_Size", "100 KByte");
        b.set_property(
            t_fast,
            "Deployment_Properties",
            "Actual_Memory_Binding",
    ...
    fn modal_budget_exceeded_in_one_som_only() {
        ...
        b.set_property(t_heavy, "Memory_Properties", "Code_Size", "120 KByte");
        b.set_property(
            t_heavy,
            "Deployment_Properties",
            "Actual_Memory_Binding",
        ...
        b.set_property(t_light, "Memory_Properties", "Code_Size", "50 KByte");
        b.set_property(
            t_light,
            "Deployment_Properties",
            "Actual_Memory_Binding",
        ...
        let diags_heavy = MemoryBudgetAnalysis.analyze_in_mode(&inst, &som_heavy);
        ...
        let diags_light = MemoryBudgetAnalysis.analyze_in_mode(&inst, &som_light);
